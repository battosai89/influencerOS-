...
const Header: React.FC<HeaderProps> = ({ onSearchClick, onMenuClick }) => {
    ...
    <header className="flex justify-between items-center animate-page-enter">
      <div className="flex items-center gap-4">
        ...
        {onMenuClick && (
          <button
            onClick={onMenuClick}
            className="md:hidden text-brand-text-secondary hover:text-brand-text-primary transition-all duration-200 ease-in-out hover:scale-110"
